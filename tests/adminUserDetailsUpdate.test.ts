...
describe('PUT /v1/admin/user/details', () => {
  ...
  test('Email is not a valid email', () => {
    const res = request('PUT', SERVER_URL + '/v1/admin/user/details', { json: { authUserId: token, email: 'gurigiurabgiurag', nameFirst: 'amelia', nameLast: 'su' }});
  ...
  test('First name contains invalid characters', () => {
    const res = request('PUT', SERVER_URL + '/v1/admin/user/details', { json: { authUserId: token, email: 'amelia@unsw.ed.au', nameFirst: 'a!melia', nameLast: 'su' }});
  ...
  test('Last name contains invalid characters', () => {
    const res = request('PUT', SERVER_URL + '/v1/admin/user/details', { json: { authUserId: token, email: 'amelia@unsw.ed.au', nameFirst: 'amelia', nameLast: 'su+' }});
  ...
  test('First name is too short', () => {
    const res = request('PUT', SERVER_URL + '/v1/admin/user/details', { json: { authUserId: token, email: 'amelia@unsw.ed.au', nameFirst: 'a', nameLast: 'su' }});
    expect(JSON.parse(res.body.toString())).toStrictEqual({ error: 'first name is too short' });
  });

  test('First name is too long', () => {
    const res = request('PUT', SERVER_URL + '/v1/admin/user/details', { json: { authUserId: token, email: 'amelia@unsw.ed.au', nameFirst: 'abcdefghijklmnopqrstuv', nameLast: 'su' }});
    expect(JSON.parse(res.body.toString())).toStrictEqual({ error: 'first name is too long'});
  });

  test('Last name is too short', () => {
    const res = request('PUT', SERVER_URL + '/v1/admin/user/details', { json: { authUserId: token, email: 'amelia@unsw.ed.au', nameFirst: 'amelia', nameLast: 's' }});
    expect(JSON.parse(res.body.toString())).toStrictEqual({ error: 'last name is too short' });
  });

  test('Last name is too long', () => {
    const res = request('PUT', SERVER_URL + '/v1/admin/user/details', { json: { authUserId: token, email: 'amelia@unsw.ed.au', nameFirst: 'amelia', nameLast: 'abcdefghijklmnopqrstuv' }});
  ...
  test('function used correctly', () => {
    const res = request('PUT', SERVER_URL + '/v1/admin/user/details', { json: { authUserId: token, email: 'amelia1@unsw.ed.au', nameFirst: 'amelia', nameLast: 'su' }});
